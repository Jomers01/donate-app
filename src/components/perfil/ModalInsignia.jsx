    ...
    >
      <Modal.Header>
        <Modal.Title id="contained-modal-title-vcenter">
          <p className='modal-title'> {infoInsignia.name} </p>
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className='modal-data'>
          <img className='modal-data__logo' src={infoInsignia.img} alt='logo insignia' />
          <p className='modal-data__info'> {infoInsignia.text} </p>
        </div>
        <p className='modal-text'> Donaciones requeridas: {infoInsignia.number} </p>
      </Modal.Body>
      <Modal.Footer>
        <Button
